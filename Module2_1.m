%% Module 2 - 1 - grayscale jpeg with rounding/quantizing matrix quantization and DCT
% most important
close all;
clear;
clc;
...
%q_mat = norm_matrix_book; % comment for the type of quantization
